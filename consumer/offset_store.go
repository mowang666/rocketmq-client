...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/mowang666/rocketmq-client/consumer  --package consumer OffsetStore
