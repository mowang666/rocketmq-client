...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/mowang666/rocketmq-client/internal  --package internal Namesrvs
